 ...
 */
class GiniStrategy : public Strategy
                         , public ProcessNackTraits<GiniStrategy>
{
public:
  explicit
  GiniStrategy(Forwarder& forwarder, const Name& name = getStrategyName());
...
PUBLIC_WITH_TESTS_ELSE_PRIVATE:
  ...
  friend ProcessNackTraits<GiniStrategy>;
};
