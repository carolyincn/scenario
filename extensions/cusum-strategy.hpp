...
#ifndef NFD_DAEMON_FW_MY_STRATEGY1_HPP
#define NFD_DAEMON_FW_MY_STRATEGY1_HPP
 ...
 */
class CusumStrategy : public Strategy
                         , public ProcessNackTraits<CusumStrategy>
{
public:
  explicit
  CusumStrategy(Forwarder& forwarder, const Name& name = getStrategyName());
...
PUBLIC_WITH_TESTS_ELSE_PRIVATE:
  ...
  friend ProcessNackTraits<CusumStrategy>;
};
